...
int main(int argc, char **argv) {
    ...
    Commander comm = Commander("Comm1", 60);
    Commander empty_comm = Commander("EmptyCommSlot", 0.0);
    Buffs buffs_1 = Buffs(8.5, 1, 1.5, 0);
    Buffs buffs_2 = Buffs(5.5, 1, 3.5, 0);
    March march_1 = March("Markswoman", 100000, 0, &troop, &buffs_1, &comm, &empty_comm);
    March march_2 = March("Markswoman", 100000, 0, &troop, &buffs_2, &comm, &empty_comm);
